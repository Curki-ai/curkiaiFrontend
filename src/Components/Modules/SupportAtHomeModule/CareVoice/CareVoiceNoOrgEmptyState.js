...
// language and flow mirror StaffOnboarding/onboarding/NoOrgEmptyState.js
// so the two surfaces feel like the same product. Two paths out:
//   1. Register your organization → POST /api/care-voice/organizations/register,
  ...
  const handleRegister = async () => {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/api/care-voice/organizations/register`,
        {
          method: "POST",
          headers: {
      ...
      console.error("[CareVoiceNoOrgEmptyState] register error:", e);
...
export default CareVoiceNoOrgEmptyState;
